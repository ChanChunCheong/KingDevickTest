class Level2 extends Phaser.Scene {
    ...
    preload(){
        this.load.image('test2', '/assets/image/test2.png'); 
    }


    create(){
        var questions = ["2", "5", "8", "0", "7", "3", "7", "9",
                        "4", "6", "5", "3", "1", "6", "4", "7",
                        "9", "7", "3", "5", "1", "5", "4", "9", "2",
                        "6", "5", "5", "7", "3", "3", "1", "8", "6",
                        "4", "5", "3", "7", "5", "2"]; 
        ...
        this.image = this.add.image(400,375, 'test2').setDepth(0);
        ...
        this.input.keyboard.on('keyup', function(e){
            ...
            if (answers[Alen - 1] != questions[Alen - 1]) {
                ...
                if (Alen == Qlen) {
                    console.log ("Correct");
                    this.scene.start("Level3", {totalTime: this.totalTime + this.timeElapsed, timeA: this.timeA, timeB: this.timeElapsed});
                }
            }
